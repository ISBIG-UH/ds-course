...
\begin{frame}{Evoluci\'on de las tecnolog\'ias de la informaci\'on}
   ...
   \note{@NOTE surge el enfoque de tratar las columnas, en lugar de las filas para el procesamiento anal\'itico. Surgen los almacenes para datos estructurados}
\end{frame}
...
\end{overlayarea}
    ...
    \note{@NOTE hizo falta almacenar datos sin esquemas definidos para poder tratrarlos en las p\'aginas web}
\end{frame}
...
\note{@NOTE el objetivo del data warehousing es integrar los datos de diferentes fuentes para poder analizarlos. Lograr identificar datos pertenecientes a la misma entidad en diferentes fuentes.}

\note{@NOTE mencionar las bds de grafos y la heterogeneidad de datos en la computaci\'on m\'ovil}

% @TODO averiguar sobre el big data
\end{frame}
