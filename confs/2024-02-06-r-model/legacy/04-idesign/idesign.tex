    ...
    \begin{small}
        ...
        \begin{block}<2->{Comparemos estos enfoques}
            Supongamos que: \begin{itemize}
                ...
                \item  {\color<2>{red}Se tiene que 500 mil jugadores pertenecen a un clan.}
            \end{itemize}
        \end{block}
    \end{small}
    ...
    \begin{small}
        ...
        \begin{block}<1->{Comparemos estos enfoques}
            Supongamos que: \begin{itemize}
                \item  Cada identificador es un entero de 64 bits y el indicador NULL tambi\'en ocupa 64 bits.
                \item  Se tienen datos de 2 millones de jugadores en la base de datos.
                \item  {\color<1>{red}{Se tiene que 1.5 millones de jugadores pertenecen a un clan.}}
            \end{itemize}
        \end{block}
    \end{small}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\linewidth}
            ...
            \onslide<2->{
                \vspace{7mm}
                \begin{itemize}
                    \item M\'as eficiente espacialmente cuando la multiplicidad
                    de la interrelaci\'on es peque\~na.
                    \item Menos eficiente para realizar operaciones sobre los datos
                \end{itemize}
            }
        \end{column}
        ...
        \begin{column}{0.5\linewidth}
            ...
            \onslide<3->{
                ...
                \begin{itemize}
                    \item M\'as eficiente espacialmente cuando la multiplicidad
                    de la interrelaci\'on es grande.
                    \item M\'as eficiente para realizar operaciones sobre los datos
                \end{itemize}
            }
        \end{column}
        ...
        \begin{column}{0.49\linewidth}
            ...
            \onslide<2->{
                ...
                \begin{scriptsize}
                    ...
                    \textbf{Coleccionar}(\underline{\#J}, \underline{\#C}, Nivel)\\[2mm]
...
\begin{frame}{Dise\~nos para la especializaci\'on (partici\'on)}
    ...
    \onslide<3>{
        ...
        \centering
        \large \textcolor{red}{Muy ineficiente espacialmente porque la intersecci\'on es vac\'ia.}
    }
\end{frame}
